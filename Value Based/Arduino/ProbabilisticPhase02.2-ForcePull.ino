//=========================================================================
//====================== PROBABILISTIC TASK ===============================
//==================== PHASE 02.2: FORCE PULL =============================
//=========================================================================

//===========================READ-ME=======================================
  //DESCRIPTION: Teach "pushers" how to pull. Mouse receives reward when 
  //moving joystick either in pull direction ONLY. A push does nothing.
...
//=======================INITIAL SETUP=====================================
  ...
  //===================JOYSTICK-RELATED=========================
    ...
    byte RewardDirection = 2; //1 is push; 2 is pull
...
void loop() {
  ...
  if (analogRead(A3) <400 && Started == 0 && BoxEntered == 1)
    {   
        Serial.println(F("ProbabilisticPhase02.2-ForcePull"));
